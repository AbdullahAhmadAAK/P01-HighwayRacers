...
LIST OF REQUIREMENTS COMPLETED IN THE SPRINT 2
...
1. Difficulty increases dynamically.
2. Realistic Collision (Sound + particle effects)
3. Pooling of terrains.
4. Adding more obstacles on tracks.
5. Converted obstacles into flat speed breakers.
6. Adding coins on the track.
...
1. we faced merging issues with github so video of gameplay will be provided. Will be using SourceTree for next sprint.

2. some features* were not completed or discarded by Mindstorm studio for this sprint which includes;

     a. game economy; collection of coins    b. powerups; invibility of bike and magnet to collect all coins

     

*these features will be implemented the next sprint along with other planned features.  




3. Compression of game; size of game will be reduced to make it more suitable for mobile.
